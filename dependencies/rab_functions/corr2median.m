function r = corr2median(varargin)
...
%   Modified  from the corr2 built in function to calculate the correlation
%   coeffcient starting from the
%   median rather than the mean of the distribution
%   Class Support
%   -------------
